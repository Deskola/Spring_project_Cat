...
public interface FeignRestClient {
    ...
    Companies requestAttachment(@PathVariable Long companyId, @RequestParam(name = "studentId") int studentId );

    @RequestMapping(method = RequestMethod.POST, value = "companies/{companyId}/attachments")
    Companies requestAttachmentInDepartment(@PathVariable Long companyId, @RequestParam(name = "studentId") int studentId,@RequestParam(name = "departmentId") Long departmentId);

    @RequestMapping(method = RequestMethod.DELETE, value = "departments")
    Companies rejectAttachment(@RequestBody int studentid, @RequestBody long companyId, @RequestBody long departmentId);

    //Companies listOfComapies()
