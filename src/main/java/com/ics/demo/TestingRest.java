...
//          System.out.println("updated"+updatemovie.toString());
        //Companies companies = feignRestClient.requestAttachment((long) 5,26);
        //Companies companies = feignRestClient.requestAttachmentInDepartment((long)5,26,(long)8);
        Companies companies = feignRestClient.rejectAttachment(26,(long)5,(long)8);

//        Student student =new Student(95697,"Dennis");
